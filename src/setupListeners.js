...
var OUTPUT_EX = 'services.events';
var INPUT_EX = 'services.digest';
exports.setupListeners = function (_a) {
    var registry = _a.registry, dbConn = _a.dbConn, channel = _a.channel;
    channel.assertExchange(OUTPUT_EX, 'topic', { durable: false });
    channel.assertExchange(INPUT_EX, 'topic', { durable: false });
    var pipesRepo = dbConn.getRepository(Pipe_1.Pipe);
    registry.forEach(function (service) {
        service.events.forEach(function (event) { return __awaiter(_this, void 0, void 0, function () {
            var routingKey, q, handler;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        routingKey = service.key + ".*." + event.key;
                    ...
                    case 1:
                        ...
                        handler = function (msg) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, pipesRepo.find({ event: routingKey })];
                                    case 1:
                                        pipes = _a.sent();
